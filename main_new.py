...
if __name__ == "__main__":
    ...
    parser.add_argument('--device_ids', type=int,default=[0],nargs='+', help='space-separated device ids')
    ...
    parser.add_argument('--on_extraction', default='save_numpy', choices=['print', 'save_numpy'],
                        help='what to do once the stack is extracted')
    parser.add_argument('--output_path', default='../../test/vid_fr', help='where to store results if saved')
    # I3D options
    ...
    parser.add_argument('--extraction_fps', type=int,default=25, help='Do not specify for original video fps')
